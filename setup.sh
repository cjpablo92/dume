...
function print_usage {
    ...
    echo -e "\tsetup.sh - Settup dev environment"
    echo ""

    echo "${bold}SYNOPSIS${normal}"
    echo -e "\tsetup.sh OPTION..."
    echo ""
    ...
    echo ""
    echo -e "\t\te.g.: ./setup -p backend"
    echo ""
    echo -e "\t-v, --verbose"
    echo -e "\t\tverbose mode on"
    echo ""
    echo -e "\t\te.g.: ./setup -p backend -v"
    echo -e "\t\te.g.: ./setup --profile backend -v"
    echo -e "\t\te.g.: ./setup --profile backend --verbose"
    echo ""
    echo -e "\t-lp, --list-profiles"
    echo -e "\t\tsee all available profiles"
    echo ""
    echo -e "\t\te.g.: ./setup -lp"
    echo -e "\t\te.g.: ./setup --list-profiles"
    echo ""
    echo -e "\t-dp, --describe-profile PROFILE (e.g.: backend, custom, ...)"
    echo -e "\t\tsee all installation scripts in a profile"
    echo ""
    echo -e "\t\te.g.: ./setup -dp backend"
    echo -e "\t\te.g.: ./setup --describe-profile backend"
    echo ""
    echo -e "\t-ls, --list-scripts"
    echo -e "\t\tsee all available scripts"
    echo ""
    echo -e "\t\te.g.: ./setup -ls"
    echo -e "\t\te.g.: ./setup --list-scripts"
    echo ""
    echo -e "\t-n, --new SCRIPT_NAME (e.g.: nmap, ...)"
    echo -e "\t\tcreate a new installation script"
    echo ""
    echo -e "\t\te.g.: ./setup -n my_installation_script"
    echo -e "\t\te.g.: ./setup --new my_installation_script"
    echo ""
    exit 1
}
